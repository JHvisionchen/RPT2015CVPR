...
%
%   Accepts positions and ground truth as N x 2 matrices (for N frames), and
%   a title string.
%
%   Joao F. Henriques, 2014
%   http://www.isr.uc.pt/~henriques/

function [precisions,mCLE] = precision_plot(positions, ground_truth, title, show)
...
% 	fprintf('%12s - Number of ground truth frames does not match number of tracked frames.\n', title)		
    ...
    mCLE = sum(distances)/size(distances,1)
