		...
		if ~isempty(boxes{1,frame}),
            for i=1:numP
                ...
                switch bb(5) 
                    ...
                    case 1
                        set(rect_h{i}, 'EdgeColor','g', 'Visible', 'on','lineStyle','--', 'LineWidth',1,'Position', bb(1:4));
                    case 2
                        set(rect_h{i}, 'EdgeColor','y', 'Visible', 'on', 'lineStyle','--','LineWidth',1,'Position', bb(1:4));
                    case 3
                        set(rect_h{i}, 'EdgeColor','r', 'Visible', 'on','lineStyle','-','LineWidth',4, 'Position', bb(1:4));
