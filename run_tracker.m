...
function [precision, fps] = run_tracker(video, kernel_type, feature_type, show_visualization, show_plots)
	...
	%base_path = 'd:\data_seq\';% You might need to change the path
...
% 	show_visualization=false;
	...
	otherwise
		...
		[precisions, mCLE] = precision_plot(positions, ground_truth, video, show_plots);
		fps = numel(img_files) / time;

		fprintf('%12s - Precision (20px):% 1.3f, mCLE:% 1.3f,FPS:% 4.2f\n', video, precisions(20),mCLE , fps)
